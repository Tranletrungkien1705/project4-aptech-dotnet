...
namespace Project4.Repository
{
    ...
    public class PageRepository : BaseRepository<Pagee>, IPageRepository
    {
        ...
        public PageRepository(ApplicationDbContext context, UserManager<CustomUser> userManager, IHttpContextAccessor contextAccessor,IConfiguration configuration) : base(context, userManager, contextAccessor)
        {
        ...
        public async Task<String> GetS3FilesImage(String image)
        {
            ...
            string accessKeyID = _configuration.GetSection("AWS")["accessKeyID"];
            string secretAccessKeyID = _configuration.GetSection("AWS")["secretAccessKeyID"];
